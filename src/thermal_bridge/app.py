...
def streamlit_app(df):
    ...
    gb.configure_column("text_size", hide=True)
    gb.configure_column("text_color", hide=True)
    gb.configure_column("Waermebruecke", width=380, autoHeight=True, wrapText=True)
    gb.configure_column("Zusatzinfo Waermebruecke", width=380, autoHeight=True, wrapText=True)
    gb.configure_column("Bezeichnung", width=1500, autoHeight=True, wrapText=True)
    gb.configure_column("Psi-Wert", width=150)
    gb.configure_column("Ref", width=70, cellStyle={"textAlign": "center"})
    gb.configure_column("WP", width=70, cellStyle={"textAlign": "center"})
    gb.configure_column("mit Referenzbauteil", width=70, cellStyle={"textAlign": "center"})
    gb.configure_column("VHAG", width=110, cellStyle={"textAlign": "center"})
